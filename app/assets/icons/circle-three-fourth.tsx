...
export function CircleThreeFourthIcon({ className }: IconProps) {
    return (
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true" className={twMerge('size-3 shrink-0', className)}>
            ...
            <path d="M6.5 2.78711C8.05763 3.02754 9.25 4.37505 9.25 6C9.25 7.79493 7.79493 9.25 6 9.25C4.3751 9.25 3.02858 8.05756 2.78809 6.5H6.5V2.78711Z" fill="currentColor" />
            <path opacity="0.25" d="M5.5 5.5H2.78809C3.00342 4.10537 4.10535 3.00238 5.5 2.78711V5.5Z" fill="currentColor" />
        </svg>
    );
}
